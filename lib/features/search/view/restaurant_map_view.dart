      ...
      body: map.loading
          ...
          : Stack(
              children: [
                CustomGoogleMapMarkerBuilder(
                  builder: (context, markers) {
                    return GoogleMap(
                      ...
                      onCameraIdle: () => ref.read(restaurantMapProvider.notifier).markRefresh(),
                ...
                if (map.focusedRestaurant != null) SearchModal(restaurant: map.focusedRestaurant!),
                SearchResultCount(count: map.place.restaurants.length),
